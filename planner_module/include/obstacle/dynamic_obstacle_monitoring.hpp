...
namespace obstacle_monitoring
{
    ...
    private:
        ...
        std::unique_ptr<nav2_costmap_2d::Costmap2D> reference_local_costmap_;
        std::unique_ptr<nav2_costmap_2d::Costmap2D> current_local_costmap_;
